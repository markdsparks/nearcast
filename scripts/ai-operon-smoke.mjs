...
assert.match(plannerSource, /function planConfidenceNoteForEvent[\s\S]*?nearcastConfidenceAffectsRecommendation/);
assert.match(plannerSource, /function planWindowConfidenceNote/);
assert.match(plannerSource, /confidenceNote \? `<p><span>Confidence<\/span>/);
assert.match(plannerSource, /confidenceNote \? `<p class="ask-decision-action"><span>Confidence<\/span>/);
