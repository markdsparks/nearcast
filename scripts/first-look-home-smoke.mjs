...
assert.match(hierarchy, /launch\.after\(nowcast, hourlyPanel, dailyPanel, map, essentials, extendedDailyPanel, els\.familyPlacesPeek/, "Home keeps air quality and daylight discoverable below seven days and Map");
