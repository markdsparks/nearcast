...
TEST_ROOT="$(mktemp -d "${TMPDIR:-/tmp}/nearcast-native-controls.XXXXXX")"
...
xcrun swiftc \
  ...
  "$ROOT/scripts/native-places-controls-test.swift" \
  -o "$TEST_ROOT/native-places-controls-test"

"$TEST_ROOT/native-places-controls-test"
