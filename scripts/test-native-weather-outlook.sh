...
TEST_ROOT="$(mktemp -d "${TMPDIR:-/tmp}/nearcast-native-outlook.XXXXXX")"
...
xcrun swiftc \
  ...
  "$ROOT/scripts/native-weather-outlook-test.swift" \
  -o "$TEST_ROOT/native-weather-outlook-test"

"$TEST_ROOT/native-weather-outlook-test"
