/* @ts-self-types="./operon_core.d.ts" */
...
export class OperonWasmSession {
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        OperonWasmSessionFinalization.unregister(this);
        return ptr;
    }
    free() {
    ...
    constructor(query, config_json) {
        ...
        const ret = wasm.operonwasmsession_new(ptr0, len0, ptr1, len1);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        this.__wbg_ptr = ret[0];
        OperonWasmSessionFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
    ...
    resume(event_json) {
        ...
        try {
            ...
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.operonwasmsession_resume(this.__wbg_ptr, ptr0, len0);
            var ptr2 = ret[0];
            var len2 = ret[1];
            if (ret[3]) {
                ptr2 = 0; len2 = 0;
    ...
    start() {
        ...
        let deferred2_1;
        try {
            const ret = wasm.operonwasmsession_start(this.__wbg_ptr);
            var ptr1 = ret[0];
            var len1 = ret[1];
            if (ret[3]) {
                ptr1 = 0; len1 = 0;
...
if (Symbol.dispose) OperonWasmSession.prototype[Symbol.dispose] = OperonWasmSession.prototype.free;

/**
 * Version owned by the Rust protocol, not by the JavaScript package.
 * @returns {string}
 */
export function execution_protocol_version() {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.execution_protocol_version();
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./operon_core_bg.js": import0,
    };
}

const OperonWasmSessionFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_operonwasmsession_free(ptr, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('operon_core_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
